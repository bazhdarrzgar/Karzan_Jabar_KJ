  ...
  return (
    <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
              ...
              {isChanging ? (
                ...
                >
                  ...
                  {typeof currentLang.flag === 'string' ? (
                    <motion.span 
                      className="text-lg drop-shadow-lg relative"
                      animate={{ 
                        textShadow: [
      ...
      <DropdownMenuContent 
        align="end" 
        className={`
          min-w-[220px] p-2 rounded-2xl border-0 shadow-2xl
            ...
            <DropdownMenuItem
              ...
              className={`
                ...
                ${i18n.language === language.code 
                  ? `bg-gradient-to-r ${language.color} bg-opacity-20 text-white shadow-lg border border-primary/30` 
            ...
            >
              ...
              >
                {typeof language.flag === 'string' ? (
                  ...
                  <div className="filter drop-shadow-sm">{language.flag}</div>
                )}
              </motion.div>
