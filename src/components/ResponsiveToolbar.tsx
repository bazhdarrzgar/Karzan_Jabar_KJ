...
const ResponsiveToolbar = () => {
  ...
  // Desktop Toolbar (1024px and up) - Always visible in header
  ...
  // Tablet Toolbar (768px to 1023px) - Enhanced slide-out panel from top-right
  if (screenSize === "tablet") {
    return (
      <div className="fixed top-4 right-4 z-50">
        <AnimatePresence>
          {!isCollapsed && (
            <>
              ...
              {/* Panel */}
              <motion.div
                className="relative z-50 min-w-[280px] p-6 rounded-2xl backdrop-blur-xl bg-white/95 dark:bg-gray-900/95 border border-white/40 dark:border-white/20 shadow-2xl"
        ...
        {/* Trigger Button - More prominent and accessible */}
        <motion.button
